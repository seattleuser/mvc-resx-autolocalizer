...
namespace ResxTranslatorRunner.Constants.Languages
{
    /// <summary>
    /// Class for language object
    /// </summary>
    ...
    { 
        ...
        /// </summary>
        public static readonly Language Unknown = new Language("Unknown", string.Empty);
        ...
        /// </summary>
        public static string[] TranslatableCollection
        {
            get
            {
                return translatableList.Where(a=>!string.IsNullOrWhiteSpace(a.TwoLetterCode)).Select(a=>a.TwoLetterCode).ToArray();
            }
        }
